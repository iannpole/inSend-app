                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center">
                            @if(is_array($product->images) && count($product->images) > 0)
                                <img src="{{ Str::startsWith($product->images[0], 'http') ? $product->images[0] : asset('storage/' . $product->images[0]) }}" alt="{{ $product->name }}" class="w-10 h-10 rounded-lg object-cover mr-3 border border-gray-200" onerror="this.onerror=null; this.src='https://ui-avatars.com/api/?name={{ urlencode($product->name) }}&color=00473B&background=E6F2ED';">
                            @else
