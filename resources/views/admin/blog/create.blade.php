...
<div class="mb-8 flex items-center gap-4">
    ...
    <div>
        ...
        <p class="text-sm text-gray-500 mt-1">Publish a new article to your blog.</p>
    </div>
</div>

<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    <div class="lg:col-span-2">
        <form action="{{ route('admin.blog.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8 space-y-6">
            @csrf

            <!-- Title -->
            <div>
                <label for="title" class="block text-sm font-semibold text-gray-900 mb-2">Post Title</label>
                <input type="text" name="title" id="title" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#00473B] focus:ring focus:ring-[#00473B] focus:ring-opacity-20 outline-none transition-all" value="{{ old('title') }}" required placeholder="e.g. 10 Benefits of Organic Vegetables">
            ...
            <div>
                ...
                <textarea name="content" id="content" rows="15" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#00473B] focus:ring focus:ring-[#00473B] focus:ring-opacity-20 outline-none transition-all font-mono text-sm" required placeholder="Write your blog content here...">{{ old('content') }}</textarea>
            ...
            <div>
                ...
                <textarea name="excerpt" id="excerpt" rows="3" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#00473B] focus:ring focus:ring-[#00473B] focus:ring-opacity-20 outline-none transition-all" placeholder="A brief summary of the post">{{ old('excerpt') }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="category" id="category" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#00473B] focus:ring focus:ring-[#00473B] focus:ring-opacity-20 outline-none transition-all" value="{{ old('category') }}" required placeholder="e.g. Health & Nutrition">
            ...
            <div>
                ...
                <input type="text" name="tags" id="tags" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#00473B] focus:ring focus:ring-[#00473B] focus:ring-opacity-20 outline-none transition-all" value="{{ old('tags') }}" placeholder="e.g. organic, healthy, diet">
    ...
    <div class="space-y-6">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <h3 class="text-sm font-bold text-gray-900 mb-3 flex items-center gap-2">
                <svg class="w-4 h-4 text-[#00473B]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                Publishing Tips
            </h3>
            <ul class="text-sm text-gray-500 space-y-3">
                <li class="flex gap-2">
                    <span class="text-[#00473B]">•</span> Use compelling titles to attract readers.
                </li>
                <li class="flex gap-2">
                    <span class="text-[#00473B]">•</span> Break up content with headings and lists.
                </li>
                <li class="flex gap-2">
                    <span class="text-[#00473B]">•</span> Add relevant tags for better searchability.
                </li>
            </ul>
        </div>
    </div>
